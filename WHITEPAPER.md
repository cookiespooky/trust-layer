...
- **Recca Trust Layer** - ядро, хранящее и обрабатывающее события, роли и веса.
- **Recca Referral System** - прикладной уровень, использующий ядро для учёта и выплаты вознаграждений.
